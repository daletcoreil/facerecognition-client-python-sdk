...
class ExtractFacesInputAllOf(object):
    ...
    def __init__(self, effort='Normal', minimum_facesize=40, face_size=160, video=None, local_vars_configuration=None):  # noqa: E501
        """ExtractFacesInputAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def effort(self):
        """Gets the effort of this ExtractFacesInputAllOf.  # noqa: E501
        ...
        :return: The effort of this ExtractFacesInputAllOf.  # noqa: E501
        :rtype: str
        """
        return self._effort
    ...
    def effort(self, effort):
        """Sets the effort of this ExtractFacesInputAllOf.

        How much effort should be invested in extracting faces from the video stream. More effort brings higher accuracy for higher cost.  # noqa: E501

        :param effort: The effort of this ExtractFacesInputAllOf.  # noqa: E501
        :type: str
        """
    ...
    def minimum_facesize(self):
        """Gets the minimum_facesize of this ExtractFacesInputAllOf.  # noqa: E501

        Minimum size of face in pixel.  Only extract a face if its bounding box is larger than this size.  # noqa: E501

        :return: The minimum_facesize of this ExtractFacesInputAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def minimum_facesize(self, minimum_facesize):
        """Sets the minimum_facesize of this ExtractFacesInputAllOf.

        Minimum size of face in pixel.  Only extract a face if its bounding box is larger than this size.  # noqa: E501

        :param minimum_facesize: The minimum_facesize of this ExtractFacesInputAllOf.  # noqa: E501
        :type: float
        """
    ...
    @property
    def face_size(self):
        """Gets the face_size of this ExtractFacesInputAllOf.  # noqa: E501
        ...
        :return: The face_size of this ExtractFacesInputAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def face_size(self, face_size):
        """Sets the face_size of this ExtractFacesInputAllOf.

        Extraction Image size in pixels.  Extracted faces are normalized as squared bitmaps with  this size.  Colors are also normalized.  # noqa: E501

        :param face_size: The face_size of this ExtractFacesInputAllOf.  # noqa: E501
        :type: float
        """
    ...
    @property
    def video(self):
        """Gets the video of this ExtractFacesInputAllOf.  # noqa: E501


        :return: The video of this ExtractFacesInputAllOf.  # noqa: E501
        :rtype: Locator
        """
        return self._video
    ...
    def video(self, video):
        """Sets the video of this ExtractFacesInputAllOf.


        :param video: The video of this ExtractFacesInputAllOf.  # noqa: E501
        :type: Locator
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExtractFacesInputAllOf):
            return False
