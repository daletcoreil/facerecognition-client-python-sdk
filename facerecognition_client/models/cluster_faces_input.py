...
class ClusterFacesInput(object):
    ...
    def __init__(self, face_extraction_id=None, cluster_collection_id='', minimum_cluster_size=2, similarity_threshold=0.5, local_vars_configuration=None):  # noqa: E501
        """ClusterFacesInput - a model defined in OpenAPI"""  # noqa: E501
    ...
    def face_extraction_id(self):
        """Gets the face_extraction_id of this ClusterFacesInput.  # noqa: E501

        ID of a FaceCollection produced by an ExtractFaces job  # noqa: E501

        :return: The face_extraction_id of this ClusterFacesInput.  # noqa: E501
        :rtype: str
        """
    ...
    def face_extraction_id(self, face_extraction_id):
        """Sets the face_extraction_id of this ClusterFacesInput.

        ID of a FaceCollection produced by an ExtractFaces job  # noqa: E501

        :param face_extraction_id: The face_extraction_id of this ClusterFacesInput.  # noqa: E501
        :type: str
        """
    ...
    def cluster_collection_id(self):
        """Gets the cluster_collection_id of this ClusterFacesInput.  # noqa: E501
        ...
        :return: The cluster_collection_id of this ClusterFacesInput.  # noqa: E501
        :rtype: str
        """
    ...
    def cluster_collection_id(self, cluster_collection_id):
        """Sets the cluster_collection_id of this ClusterFacesInput.

        Optional field - if provided, cluster faces of the input collectionId into an existing clusterCollection, else create a new clusterCollection.  # noqa: E501

        :param cluster_collection_id: The cluster_collection_id of this ClusterFacesInput.  # noqa: E501
        :type: str
        """
    ...
    def minimum_cluster_size(self):
        """Gets the minimum_cluster_size of this ClusterFacesInput.  # noqa: E501

        Minimum number of images in a cluster.  Clusters with less candidates than this number will be filtered out.  # noqa: E501

        :return: The minimum_cluster_size of this ClusterFacesInput.  # noqa: E501
        :rtype: float
        """
    ...
    def minimum_cluster_size(self, minimum_cluster_size):
        """Sets the minimum_cluster_size of this ClusterFacesInput.

        Minimum number of images in a cluster.  Clusters with less candidates than this number will be filtered out.  # noqa: E501

        :param minimum_cluster_size: The minimum_cluster_size of this ClusterFacesInput.  # noqa: E501
        :type: float
        """
    ...
    def similarity_threshold(self):
        """Gets the similarity_threshold of this ClusterFacesInput.  # noqa: E501
        ...
        :return: The similarity_threshold of this ClusterFacesInput.  # noqa: E501
        :rtype: float
        """
    ...
    def similarity_threshold(self, similarity_threshold):
        """Sets the similarity_threshold of this ClusterFacesInput.

        Similarity threshold (from 0 to 1) over which face candidates are grouped into a cluster.  Higher value produces more smaller clusters with higher confidence.  # noqa: E501

        :param similarity_threshold: The similarity_threshold of this ClusterFacesInput.  # noqa: E501
        :type: float
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterFacesInput):
            return False
