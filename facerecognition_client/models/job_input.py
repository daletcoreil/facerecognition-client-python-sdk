...
class JobInput(object):
    ...
    def job_input_type(self):
        """Gets the job_input_type of this JobInput.  # noqa: E501


        :return: The job_input_type of this JobInput.  # noqa: E501
        :rtype: str
        """
    ...
    def job_input_type(self, job_input_type):
        """Sets the job_input_type of this JobInput.


        :param job_input_type: The job_input_type of this JobInput.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and job_input_type is None:  # noqa: E501
            raise ValueError("Invalid value for `job_input_type`, must not be `None`")  # noqa: E501
