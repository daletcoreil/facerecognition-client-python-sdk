...
import facerecognition_client.models
from facerecognition_client import rest
from facerecognition_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(facerecognition_client.models, klass)
