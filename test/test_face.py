...
from facerecognition_client.models.face import Face  # noqa: E501
...
class TestFace(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = facerecognition_client.models.face.Face()  # noqa: E501
        if include_optional :
            return Face(
                uid = '0', 
                source_extraction = '0', 
                frame_in_source = 56, 
                bbox = facerecognition_client.models.face_bbox.Face_bbox(
                    left = 56, 
                    top = 56, 
                    width = 56, 
                    height = 56, ), 
                image_url = '0', 
                detected_entity = facerecognition_client.models.face_detected_entity.Face_detectedEntity(
                    identity = '0', 
                    confidence = 1.337, 
