...
from facerecognition_client.models.search_faces_input import SearchFacesInput  # noqa: E501
from facerecognition_client.rest import ApiException

class TestSearchFacesInput(unittest.TestCase):
    """SearchFacesInput unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SearchFacesInput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = facerecognition_client.models.search_faces_input.SearchFacesInput()  # noqa: E501
        if include_optional :
            return SearchFacesInput(
