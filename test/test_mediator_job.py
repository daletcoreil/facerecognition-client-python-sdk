...
from facerecognition_client.models.mediator_job import MediatorJob  # noqa: E501
from facerecognition_client.rest import ApiException

class TestMediatorJob(unittest.TestCase):
    """MediatorJob unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = facerecognition_client.models.mediator_job.MediatorJob()  # noqa: E501
        if include_optional :
            return MediatorJob(
                id = '0', 
                date_created = '0', 
                date_modified = '0', 
                quantity = 56, 
                status = facerecognition_client.models.job_mediator_status.JobMediatorStatus(
                    status = 'NEW', 
                    status_message = '0', 
                    progress = 56, ), 
                job_output = facerecognition_client.models.job_output.JobOutput(
                    job_output_type = '0', )
            )
        else :
            return MediatorJob(
