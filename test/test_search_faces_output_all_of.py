...
from facerecognition_client.models.search_faces_output_all_of import SearchFacesOutputAllOf  # noqa: E501
from facerecognition_client.rest import ApiException

class TestSearchFacesOutputAllOf(unittest.TestCase):
    """SearchFacesOutputAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SearchFacesOutputAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = facerecognition_client.models.search_faces_output_all_of.SearchFacesOutputAllOf()  # noqa: E501
        if include_optional :
            return SearchFacesOutputAllOf(
                search_result = [
                    facerecognition_client.models.search_faces_output_item.SearchFacesOutputItem(
                        cluster_id = '3f9b1898-9d9f-11ea-925a-6a51797d0d28', 
                        confidence = 0.56, 
                        cluster_collection_id = '12345', )
                    ]
            )
        else :
            return SearchFacesOutputAllOf(
    ...
    def testSearchFacesOutputAllOf(self):
        """Test SearchFacesOutputAllOf"""
