...
from facerecognition_client.models.extract_faces_input_all_of import ExtractFacesInputAllOf  # noqa: E501
from facerecognition_client.rest import ApiException

class TestExtractFacesInputAllOf(unittest.TestCase):
    """ExtractFacesInputAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ExtractFacesInputAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = facerecognition_client.models.extract_faces_input_all_of.ExtractFacesInputAllOf()  # noqa: E501
        if include_optional :
            return ExtractFacesInputAllOf(
                effort = 'Normal', 
                minimum_facesize = 40, 
                face_size = 1.337, 
                video = facerecognition_client.models.locator.Locator(
    ...
    def testExtractFacesInputAllOf(self):
        """Test ExtractFacesInputAllOf"""
