...
from facerecognition_client.models.extract_faces_output_all_of import ExtractFacesOutputAllOf  # noqa: E501
from facerecognition_client.rest import ApiException

class TestExtractFacesOutputAllOf(unittest.TestCase):
    """ExtractFacesOutputAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ExtractFacesOutputAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = facerecognition_client.models.extract_faces_output_all_of.ExtractFacesOutputAllOf()  # noqa: E501
        if include_optional :
            return ExtractFacesOutputAllOf(
                face_extraction_id = '12345', 
                n_faces = 1.337
            )
        else :
            return ExtractFacesOutputAllOf(
    ...
    def testExtractFacesOutputAllOf(self):
        """Test ExtractFacesOutputAllOf"""
